...
<body>
	<%-- number변수를 생성하고 숫자 100 저장 !  number변수는 page내장객체에 저장  --%>
	...
	<form> <%-- 먼저 폼값을 전송하기 위해 <form>태그를 사용합니다. 
				전송방식과 URL을 입력하지 않았으므로 폼값은 현재 페이지로 쿼리 스트링을 통해 전송합니다. --%>
	...
	<%-- 현재 페이지에 첫 진입시에는 전송된 폼값이 없습니다. 
	          그래서 request에 입력한 값이 없다면 결과가 출력되지 않게 하기 위해 c:if를 사용합니다.
