...
<body>
	<h4>향상된 for문 형태의 forEach 태그 사용해보기</h4>
	<%
	...
	<%--
		 ...
		 변수이름은 c로 생성했습니다.
		 items속성에 지정한 배열의 크기만큼  반복해서 0 index 위치의 문자열"Red"부터  3 index위치의 문자열 "Black"까지 
		 차례로 반복해서 얻어서 출력합니다.  4 index위치는 없으므로 꺼내오려고 할때 c:forEach문을 빠져 나가 종료 됩니다.
	 --%>
