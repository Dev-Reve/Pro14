...
<%--
	 <c:redirect>태그
	 - 이태그는 response내장객체의 sendRedirect()메소드를 호출한 포워딩을 통한 페이지 이동을 처리하는 태그입니다.
	 - 문법
	 ...
	 - 재요청시  다른 서버페이지로  전달할 값이 있다면  <c:param>태그를 내부에 사용하면 됩니다.
...
<body>
	<%-- requestVar변수를 만들고 "홍길동" 저장 !  그리고 request내장객체 영역에 requestVar변수 저장 --%>
