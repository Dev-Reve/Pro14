...
//forward4.jsp페이지에서 request내장객체에 address속성이름과 함께 "서울시 강남구"를 바인딩했었습니다
//현재 member4.jsp페이지에서 session내장객체에 똑같은 address속성이름으로 다른값 "수원시 팔달구"를 바인딩 합니다.
...
<body>
	...
	<%--  위 표현 언어로 address속성이름과 같은 이름으로 각 내장객체에 저장된  값을 얻어 출력시!  
		...
		결론:  위 ${address}는   requestScope.이 생략되어   request내장객체 영역에 바인딩된 address속성이름의 값을 얻어 출력한것임
